...
<body onload="removeLoader()">
            ...
            <nav class="navbar navbar-expand fixed-top navbar-dark nav-new mt-5 px-0 py-2" style="max-height: 9vh;">
                <div class="container">
                    <a class="navbar-brand fs-4 fw-bold navbar-brand-custom text-light" href="#">
                        <img src="{{ asset('/brand/umroh-logo.png') }}" alt="Bootstrap" class="img-brand" style="">
    ...
    <div class="scrollbar-custom">
                ...
                <div class="container-fluid">
                    <div class="navigation d-flex justify-content-center" style="margin-bottom: -2vh;">
                        <ul class="navigation-bar navbar-responsive-custom d-flex px-4" style="background: #FFC108;">
                            ...
                            <li class="d-flex flex-column">
                                <span class="fw-bold"><i class='bx bx-calendar'></i> Jad wal Keberangkatan</span>
                            </li>
                            <li class="d-flex flex-column">
        ...
        <section class="home-wrapper" style="border-radius: 50px;">
            <div class="container position-relative">
                <ul class="carousel overflow-hidden container position-relative mt-4">
                    ...
                    <li class="ads">
                        <div class="img">
                            <img src="{{ asset('storage/' . $carousel->media) }}" alt="">
                        </div>
                    </li>
                    @endforeach
                </ul>
                            ...
                            <div class="container">
                                ...
                                <div class="sub-detail mt-4 mb-5">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-1">:</div>
                                        <div class="col-5">{{ $item->tanggal_keberangkatan }}</div <div class="col-6">
                            ...
                            <div class="container">
                                ...
                                <div class="sub-detail mt-4 mb-5">
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-5">Rp. {{ number_format($item->harga) }},00</div>
                                        <div class="col-12 mt-5">
                                            <h6 class="fw-semibold text-green-custom mb-3 judul-sub-detail shadow">Harga Sudah Termasuk</h6>
                                            <hr>
                                        </div>
                                        <div class="col-12">
                                            <div class="row justify-content-start text-center">
                                                @if ($item->tiket == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Tiket Pesawat <i class="fa-solid fa-plane-departure ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->visa == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Visa-Siskohat <i class="fa-brands fa-cc-visa ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->akomodasi == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Akomodasi di Saudi <i class="fa-solid fa-hotel ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->makan == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Makan di Saudi <i class="fa-solid fa-utensils ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->umroh == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Umroh 3 Kali <i class="fa-solid fa-kaaba ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->tour != null)
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Paket Tour <i class="fa-solid fa-kaaba ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->airpot == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Airport Handling <i class="fa-solid fa-plane-departure ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->bus == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Bus Selama di Saudi <i class="fa-solid fa-bus ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->zam == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Zam-zam 5 Liter <i class="fa-solid fa-bottle-water ms-2"></i></p>
                                                </div>
                                                @endif
                                                @if ($item->passport == 'yes')
                                                <div class="col-xl-3 col-md-6 col-sm-6">
                                                    <p class="ms-0 mt-0 mb-3 me-0 fasilitas">Passport <i class="fa-solid fa-passport ms-2"></i></p>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
        ...
        <div class="modal fade mt-5" id="registerModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="input-group mb-2">
                                        ...
                                        <input class="form-control" type="text" name="pemilik" id="pemilik"
                                            placeholder="Input Pemilik" required </div>
                                </div>
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="input-group mb-2">
                                        <span class="input-group-text text-center text-secondary" id="basic-addon1"
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-12">
                                    <div class="form-floating mb-2">
                                        <input class="form-control" type="date" name="pulang" id="floatingInputValue"
                                            placeholder="Input Tanggal Kepulangan" required>
